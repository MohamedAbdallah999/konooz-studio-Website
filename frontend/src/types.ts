...
export interface Sale{id:string;totalAmount:number;customerName?:string|null;discountPercentage:number;items:SaleLine[];createdAt:string;updatedAt:string;syncStatus:SyncStatus;deletedAt?:string|null}
