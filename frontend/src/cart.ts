...
export function cartCounts(cart: CartLine[]) {
  return cart.reduce((totals, line) => ({
    totalPacks: totals.totalPacks + line.numberOfPacks,
    totalPieces: totals.totalPieces + line.numberOfPacks * line.pack.sizesPerPack,
